...
def build_docs():
    ...
    os.system(
        "sphinx-build -M html -D version={version} source build".format(
...
class BuildDocumentationCommand(SetupCommand):
    ...
    def run(self):
        ...
        version_dir = os.path.join(
            here, "docs", "version={version}".format(version=about["__version__"])
        )
        self.rmdir_if_exists(
            version_dir
        )  # Need to delete this before building HTML docs
